...
import { Leaf, Diamond, Star, Award, Sparkles, ChevronLeft, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-dark-900 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-serif text-center mb-16 text-transparent bg-clip-text bg-gradient-to-r from-gold-400 to-gold-600">
          {t('about.title')}
        </h1>
        ...
        <div className="bg-dark-800/50 backdrop-blur-sm p-8 md:p-12 rounded-2xl border border-gold-500/20 mb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <h3 className="text-lg text-gold-400 mb-6">
        ...
        <div className="bg-dark-800/50 backdrop-blur-sm p-8 md:p-12 rounded-2xl border border-gold-500/20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="mb-6">
                <h3 className="text-lg font-medium text-gold-400 mb-4 flex items-center gap-2">
